...
- [x] `make verify` grün
- [x] Nach Push: Workflow „Security Scans" komplett grün (alle `vuln-scan-go`-Jobs, `vuln-scan-go-windows`, `vuln-scan-npm`), Workflow „CI" grün
...
- [x] Nach Push: Workflows „CI" und „Security Scans" grün
