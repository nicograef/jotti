...
| ----------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| `AEAO-zu-146a-2023-06-30.pdf`                   | Anwendungserlass zur AO zu § 146a (Neufassung, 20 S.)                  | Offizielle processType-Definitionen (Anhang I), Eingabegeräte (BYOD), Seriennummer, Belegpflicht     |
...
| `Kassenmeldepflicht-BMF-2024-06-28.pdf`         | BMF-Schreiben Mitteilungsverpflichtung § 146a Abs. 4 AO                | ELSTER-Meldepflicht: Payload, Fristen, Eingabegeräte ohne Meldepflicht                               |
...
| `BSI-TR-03153-2.pdf`                                       | BSI TR-03153 Teil 2                                | Schnittstelle und Datenformate                                                                                                |
