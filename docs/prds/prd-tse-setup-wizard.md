...
> Herkunft: ausgelagert aus Phase 5 der TSE-fiskaly-Fixes-Planung (Entscheidung 2026-06-11, dort unter „Resolved decisions" dokumentiert)
> Quellen: TSE-fiskaly-Audit vom 2026-06-11 (Findings I-09, I-15.4, D-07)
> Ersetzt die frühere Festlegung der TSE-Integration („Betreiber legt TSS und Client im fiskaly-Dashboard an; jotti betreibt keinen TSS-Lebenszyklus"), siehe Further Notes.
