...
- **Design-Logik:** Das `J` trägt einen kontinuierlichen Spektral-Verlauf von Rot (oben) über Grün (Mitte) nach Violett (unten); die Faltschattierung liegt als Helligkeitsverlauf darüber.
...
| --------------------------------------------- | ------------------------------------ | ----------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- |
| 2 (`jotti-logo-icon-dark.png`)                | Dark Icon                            | Quadrat, abgerundet. Hintergrund: Slate-950 (`#020617`). `J` Spektral-Verlauf Rot → Violett (helle Ausprägung).                           | App Store, Launcher Icon, Desktop Shortcut                            | Quadratisches Icon auf dunklem Hintergrund (z. B. PWA-Piktogramm auf einem dunklen Smartphone-Hintergrund). |
| 3 (`jotti-logo-icon-light.png`)               | Light Icon                           | Quadrat, abgerundet. Hintergrund: Slate-50 (`#f8fafc`). `J` Spektral-Verlauf Rot → Violett (sattere Ausprägung).            | App Store, Launcher Icon, Desktop Shortcut                            | Quadratisches Icon auf hellem Hintergrund.                                                                  |
...
| 6 (`jotti-symbol.png`)                        | J Symbol                             | Isoliert auf transparentem Hintergrund. Reines gefaltetes `J` (Spektral-Verlauf wie #3), ohne Hintergrund-Quadrat. | UI-Icon, Marketing, PWA-Titelzeile                                    | Für allgemeine UI-Symbole, in der Titelzeile der PWA, oder über Bildmaterial im Marketing.                  |
| 7 (`jotti-icon-light-16.png`)                 | Light Favicon 16×16                  | Transparenter Hintergrund. J-Symbol, Spektral-Verlauf (Light-Ausprägung).                                           | Browser-Tab-Favicon                                                   | Smallest Favicon für Browser-Tab.                                                                           |
| 8 (`jotti-icon-light-32.png`)                 | Light Favicon 32×32                  | Transparenter Hintergrund. J-Symbol, Spektral-Verlauf (Light-Ausprägung).                                                                     | Browser-Tab-Favicon, Lesezeichen                                      | Standard-Favicon für Browser-Tab und Lesezeichen-Ansicht.                                                   |
| 9 (`jotti-icon-light-64.png`)                 | Light Favicon 64×64                  | Transparenter Hintergrund. J-Symbol, Spektral-Verlauf (Light-Ausprägung).                                                                     | Desktop-Verknüpfung, Taskbar                                          | Größeres Favicon für Desktop-Shortcuts und Taskbar-Icons.                                                   |
| 10 (`jotti-icon-dark-16.png`)                 | Dark Favicon 16×16                   | Transparenter Hintergrund. J-Symbol, Spektral-Verlauf (Dark-Ausprägung).                                            | Browser-Tab-Favicon (Dark Mode)                                       | Kleinster Favicon für Browser-Tab im Dark Mode.                                                             |
| 11 (`jotti-icon-dark-32.png`)                 | Dark Favicon 32×32                   | Transparenter Hintergrund. J-Symbol, Spektral-Verlauf (Dark-Ausprägung).                                                                      | Browser-Tab-Favicon (Dark Mode), Lesezeichen                          | Standard-Favicon für Dark-Mode-Browser.                                                                     |
| 12 (`jotti-icon-dark-64.png`)                 | Dark Favicon 64×64                   | Transparenter Hintergrund. J-Symbol, Spektral-Verlauf (Dark-Ausprägung).                                                                      | Desktop-Verknüpfung (Dark Mode), Taskbar                              | Größeres Favicon für Desktop-Shortcuts im Dark Mode.                                                        |
...
| ----- | --------------------------------- | --------------------------------------------------------- | ------------------------------------------------------------- |
| 7–9   | `jotti-icon-light-{16,32,64}.png` | J-Symbol, transparenter Hintergrund, Spektral-Verlauf (Light)        | Browser-Favicons (Light Mode), Lesezeichen, Desktop-Shortcuts |
| 10–12 | `jotti-icon-dark-{16,32,64}.png`  | J-Symbol, transparenter Hintergrund, Spektral-Verlauf (Dark)         | Browser-Favicons (Dark Mode), Lesezeichen, Desktop-Shortcuts  |
