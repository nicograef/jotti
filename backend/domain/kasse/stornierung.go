...
type Stornierung struct {
	...
	// BarRueckgabe wird zur Lesezeit aus dem Event-Typ abgeleitet, nie im Event
	// gespeichert: true bei `stornierung-erteilt:v1` (kassenwirksame Warenrücknahme),
	// false bei `bestellung-korrigiert:v1` (geldneutrale Korrektur).
	BarRueckgabe bool
}
