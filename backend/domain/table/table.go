...
// ErrTableLocked is returned when a table is locked.
var ErrTableLocked = errors.New("table is locked")
...
type persistence interface {
	...
	UpdateTable(id int, name string, locked bool) error
}
...
func (s *Service) UpdateTable(id int, name string, locked bool) (*Table, error) {
	err := s.DB.UpdateTable(id, name, locked)
	if err != nil {
