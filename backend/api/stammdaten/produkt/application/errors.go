...
// ErrProduktNotFound is returned when a produkt is not found.
var ErrProduktNotFound = errors.New("produkt not found")

// ErrProduktAlreadyExists is returned when trying to create a produkt that already exists.
var ErrProduktAlreadyExists = errors.New("produkt already exists")

// ErrVarianteNotFound is returned when a variante is not found.
...
// ErrInvalidProduktData is returned when the provided produkt data is invalid.
var ErrInvalidProduktData = errors.New("invalid produkt data")

// ErrInvalidVarianteData is returned when the provided variante data is invalid.
