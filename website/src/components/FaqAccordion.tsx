...
const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    a: 'Nein. jotti läuft im Browser auf den Smartphones, Tablets und Rechnern, die ihr schon habt (BYOD). Für Kassenbelege und Küchenbons genügt ein handelsüblicher ESC/POS-Bondrucker mit 80 mm Papier, im Netzwerk erreichbar (Ethernet oder WLAN), TCP-Port 9100, feste IP-Adresse empfohlen.',
  },
  {
