...
COMMENT ON COLUMN tables.updated_at IS 'Last modification timestamp (UTC)';
...
COMMENT ON COLUMN products.updated_at IS 'Last modification timestamp (UTC)';
...
COMMENT ON COLUMN product_variants.updated_at IS 'Last modification timestamp (UTC)';
