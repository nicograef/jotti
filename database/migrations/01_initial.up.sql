...
COMMENT ON COLUMN events.sequence IS 'Monotonic sequence number for ordering events';
...
CREATE INDEX IF NOT EXISTS idx_events_subject_sequence ON events (subject, sequence);
