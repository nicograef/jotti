...
// Badge-Variant. Bewusst keine Rolle-zu-Farbe-Zuordnung (z. B. Admin default,
// Serviceleitung outline, Service secondary) — unterschiedliche Badge-Farben
// pro Rolle sind ein Farbrätsel ohne Legende und tragen keine Bedeutung, die
// der Text nicht schon eindeutig trägt.
