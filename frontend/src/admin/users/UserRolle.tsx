...
// Bewusst keine Rolle-zu-Farbe-Zuordnung: unterschiedliche Badge-Farben pro
// Rolle sind ein Farbrätsel ohne Legende und tragen keine Bedeutung, die das
// ausgeschriebene Label nicht schon trägt.
