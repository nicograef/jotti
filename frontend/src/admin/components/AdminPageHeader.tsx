...
// Einheitlicher Seitenkopf aller acht Admin-Seiten: H1 24 px/700, darunter
// eine erklärende Unterzeile 14 px in muted-foreground und rechts ein
// Aktions-Slot (etwa der Anlegen-Button). Dahinter ein dekorativer
// Spektral-Glow (HeaderGlow); das optionale Farbpaar variiert ihn je Seite,
// Default teal+violett.
