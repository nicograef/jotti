...
// Sichtkontakt lesbar ist. role="img" statt role="status": Der Punkt trägt
// Bedeutung (roter Punkt = Problem), soll aber nicht als Live-Region bei jedem
// Refetch neu vorgelesen werden.
//
